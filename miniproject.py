...
ref_cds = 4140 #number of codign regions in the reference
genemark_fasta = open(predicted_path, 'r') #open the file containing prediced CDS
genemark_seq = genemark_fasta.read() #read in contents of CDS file
seq_cds = genemark_seq.count('>') #count the number of CDS in the assembled genome
